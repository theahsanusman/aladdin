...
describe("public event manifest", () => {
  ...
  test("uses canonical definitions for current public events", () => {
    ...
    const liveV1 = EventManifest.Definitions.findIndex((definition) => definition === SessionV1.Event.PartDelta)
    expect(EventManifest.Definitions.slice(liveV1, liveV1 + 3)).toEqual([
      SessionV1.Event.PartDelta,
      SessionV1.Event.Diff,
      SessionV1.Event.Error,
    ])
