...
describe("plugin.codex", () => {
  ...
  test("filters unsupported modes and uses Codex context limits for OAuth GPT models", async () => {
    ...
    expect(models["gpt-5.5"]?.limit).toEqual({ context: 272_000, input: 272_000, output: 128_000 })
    expect(models["gpt-5.6-sol"]?.limit).toEqual({ context: 272_000, input: 272_000, output: 128_000 })
    expect(models["gpt-5.6-terra"]?.limit).toEqual({ context: 272_000, input: 272_000, output: 128_000 })
    expect(models["gpt-5.6-luna"]?.limit).toEqual({ context: 272_000, input: 272_000, output: 128_000 })
