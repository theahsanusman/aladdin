...
import { aladdinHandlers } from "../../src/server/routes/instance/httpapi/handlers/aladdin"
...
const apiLayer = HttpRouter.serve(
  HttpApiBuilder.layer(RootHttpApi).pipe(
    Layer.provide([aladdinHandlers, controlHandlers, controlPlaneHandlers, globalHandlers]),
