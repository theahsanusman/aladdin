...
export const dict = {
  ...
  "session.goal.completed": "Goal completed",
  "session.goal.elapsed.hours": "{{hours}}h {{minutes}}m",
  "session.goal.elapsed.minutes": "{{minutes}}m {{seconds}}s",
  "session.goal.elapsed.seconds": "{{seconds}}s",
  "session.goal.pause": "Pause goal",
  "session.goal.resume": "Resume goal",
  "session.goal.clear": "Clear goal",
  "session.goal.error": "Goal update failed",
  "session.question.progress": "{{current}} of {{total}} questions",
  "session.question.minimize": "Minimize question",
  "session.question.restore": "Restore question",
  "session.question.countdown": "Auto-continues in {{time}}",
  "session.question.continuing": "Continuing with the recommended option",
  "session.question.skip": "Skip",
  "session.question.expired.title": "Question timed out",
  "session.question.expired.description":
    "The agent continued with the recommended option and will state any assumptions in its reply.",
  ...
  "session.followupDock.reorder": "Reorder queued message (Alt + Arrow keys)",
  ...
  "automations.description": "Scheduled work that runs unattended while the app is open.",
  "automations.status.active": "Active",
  "automations.status.paused": "Paused",
  "automations.badge.verified": "Verification",
  "automations.nextRun": "Next run {{time}}",
  "automations.lastRun": "Last run: {{outcome}} {{time}}",
  "automations.runs.empty": "No runs yet.",
  "automations.run.openSession": "Open session",
  "automations.run.tokens": "{{count}} tokens",
  "automations.empty.title": "No automations yet",
  "automations.empty.description": "Schedule a prompt to run on a recurring schedule. Each run works in its own session, and the results show up here.",
  "automations.error.load": "Failed to load automations",
  "automations.error.create": "Failed to create automation",
  "automations.error.update": "Failed to update automation",
  "automations.error.delete": "Failed to delete automation",
  "automations.error.run": "Failed to start run",
  "automations.error.read": "Failed to mark runs read",
  "automations.toast.created": "Automation created",
  "automations.toast.deleted": "Automation deleted",
  "automations.toast.started": "Run started",
  "automations.action.create": "New automation",
  "automations.action.refresh": "Refresh",
  "automations.action.markAllRead": "Mark all read",
  ...
  "automations.action.showRuns": "Runs",
  "automations.action.hideRuns": "Hide runs",
  "automations.outcome.verified": "Verified",
  "automations.outcome.verificationFailed": "Verification failed",
  "automations.outcome.budgetExceeded": "Budget exceeded",
  "automations.outcome.timedOut": "Timed out",
  "automations.outcome.providerError": "Provider error",
  "automations.outcome.cancelled": "Cancelled",
  "automations.outcome.budgetExhausted": "Daily budget exhausted",
  "automations.outcome.previousRunActive": "Skipped, previous run active",
  "automations.outcome.projectUnavailable": "Project unavailable",
  "automations.outcome.sessionUnavailable": "Session unavailable",
  "automations.outcome.reported": "Reported",
  "automations.dialog.title": "New automation",
  "automations.dialog.directory": "Project",
  "automations.dialog.prompt": "Prompt",
  "automations.dialog.promptPlaceholder": "What should this automation do each run?",
  "automations.dialog.schedule": "Schedule",
  "automations.dialog.scheduleHint": "Examples: \"every 30 minutes\", \"daily at 08:00\", \"weekly on monday at 09:00\", \"cron 0 9 * * 1-5\"",
  "automations.dialog.profile": "Permission profile",
  "automations.dialog.profileHint": "Unattended runs never prompt; the profile decides what they may touch.",
  "automations.dialog.name": "Name",
  "automations.dialog.namePlaceholder": "Optional, defaults to the prompt",
  "automations.dialog.verification": "Verification commands",
  "automations.dialog.verificationHint": "One command per line; each must exit 0 for the run to pass.",
  "automations.dialog.budgetPerRun": "Token budget per run",
  "automations.dialog.budgetPerDay": "Token budget per day",
  "automations.dialog.timeout": "Timeout (minutes)",
  ...
  "app.name.desktop": "Aladdin Desktop",
  ...
  "settings.usage.range.aria": "Usage time range",
  "settings.usage.range.24h": "24 hours",
  "settings.usage.range.7d": "7 days",
  "settings.usage.range.30d": "30 days",
  "settings.usage.range.all": "All time",
  "settings.usage.card.cost": "Cost",
  "settings.usage.card.costHint": "Across {{responses}} responses",
  "settings.usage.card.tokens": "Tokens",
  "settings.usage.card.tokensHint": "{{input}} in / {{output}} out / {{cache}} cached",
  "settings.usage.card.responses": "Responses",
  "settings.usage.card.responsesHint": "Across {{count}} providers",
  "settings.usage.card.cache": "Cache reads",
  "settings.usage.card.cacheHint": "{{read}} read / {{write}} written",
  "settings.usage.chart.cost": "Daily cost",
  "settings.usage.chart.tokens": "Daily tokens",
  "settings.usage.chart.bar": "{{date}} - {{cost}} - {{tokens}} tokens",
  "settings.usage.models.name": "Provider / Model",
  "settings.usage.models.responses": "Responses",
  "settings.usage.models.tokens": "Tokens",
  "settings.usage.models.cost": "Cost",
  "settings.usage.empty": "No usage recorded in this range yet.",
  "settings.usage.loading": "Loading usage...",
  "settings.usage.error": "Usage could not be loaded.",
  "settings.tab.shortcuts": "Shortcuts",
  "settings.aladdin.tab.accounts": "Accounts",
  "settings.aladdin.tab.images": "Images",
  "settings.aladdin.tab.mobile": "Mobile",
  "settings.aladdin.tab.voice": "Voice",
  "settings.aladdin.tabs.aria": "Aladdin settings",
  "settings.aladdin.accounts.title": "ChatGPT accounts",
  "settings.aladdin.accounts.personal": "Personal",
  "settings.aladdin.accounts.company": "Company",
  "settings.aladdin.accounts.connected": "Connected",
  "settings.aladdin.accounts.connectedActive": "Connected · Active",
  "settings.aladdin.accounts.notSaved": "Not saved",
  "settings.aladdin.accounts.identityUnknown": "Identity unavailable; reconnect to verify",
  "settings.aladdin.accounts.connect": "Connect",
  "settings.aladdin.accounts.save": "Save current login",
  "settings.aladdin.accounts.use": "Use",
  "settings.aladdin.accounts.help":
    "Connect opens ChatGPT sign-in and saves that login here. To label an existing OpenAI login, use Save current login. Sign out of ChatGPT in your browser before connecting the other account if it automatically chooses the first one.",
  "settings.aladdin.accounts.error.title": "ChatGPT account could not be updated",
  "settings.aladdin.accounts.error.signIn":
    "Complete ChatGPT sign-in for this slot. If your browser reused the other account, sign out there and try again.",
  "settings.aladdin.accounts.error.notSavedPersonal": "The personal account has not been saved yet.",
  "settings.aladdin.accounts.error.notSavedCompany": "The company account has not been saved yet.",
  "settings.aladdin.accounts.savedPersonal": "Personal account saved",
  "settings.aladdin.accounts.savedCompany": "Company account saved",
  "settings.aladdin.accounts.switchedPersonal": "Switched to personal",
  "settings.aladdin.accounts.switchedCompany": "Switched to company",
  "settings.aladdin.title": "Aladdin",
  "settings.aladdin.section.voiceInput": "Voice input",
  "settings.aladdin.section.voiceOutput": "Voice output",
  "settings.aladdin.section.images": "Image generation",
  "settings.aladdin.section.mobileGoals": "Mobile",
  "settings.aladdin.voice.inputModel.title": "Speech-to-text model",
  "settings.aladdin.voice.inputModel.description": "Runs locally on this Mac. Audio is not sent to a cloud service.",
  "settings.aladdin.status.title": "Local service",
  "settings.aladdin.status.description":
    "Aladdin checks the loopback service on this Mac without exposing it to the network.",
  "settings.aladdin.status.checking": "Checking…",
  "settings.aladdin.status.ready": "Ready",
  "settings.aladdin.status.offline": "Not running",
  "settings.aladdin.status.error": "Could not check Aladdin services",
  "settings.aladdin.voice.outputModel.title": "Text-to-speech model",
  "settings.aladdin.voice.outputModel.description": "Runs locally through the Aladdin voice service.",
  "settings.aladdin.voice.voice.title": "Voice",
  "settings.aladdin.voice.voice.description": "Choose a preset, designed, or authorized imported voice.",
  "settings.aladdin.voice.custom.title": "Custom voice",
  "settings.aladdin.voice.custom.description": "Use a designed or imported voice name provided by the local service.",
  "settings.aladdin.voice.presets.title": "Preset voices",
  "settings.aladdin.voice.presets.description": "Play each voice to hear it, then choose the one you want.",
  "settings.aladdin.voice.presets.offline": "Start the local voice service to list voices",
  "settings.aladdin.voice.presets.preview": "Play {{voice}}",
  "settings.aladdin.voice.presets.stop": "Stop playing {{voice}}",
  "settings.aladdin.voice.presets.choose": "Choose",
  "settings.aladdin.voice.presets.use": "In use",
  "settings.aladdin.voice.presets.selected": "This voice is in use",
  "settings.aladdin.voice.preview.text": "Hi, this is how I sound when I read your replies out loud.",
  "settings.aladdin.voice.preview.error.title": "Voice preview failed",
  "settings.aladdin.voice.callSilence.title": "Call silence timeout",
  "settings.aladdin.voice.callSilence.description": "End a call turn after 2–5 seconds of silence.",
  "settings.aladdin.voice.callSilence.value": "{{seconds}}s",
  "settings.aladdin.voice.voice.placeholder": "Ryan, designed voice, or imported voice",
  "settings.aladdin.image.provider.title": "Default provider",
  "settings.aladdin.image.provider.description": "Choose cloud generation or Draw Things on this Mac.",
  "settings.aladdin.image.model.title": "Default image model",
  "settings.aladdin.image.model.description": "Use the exact model ID supported by the selected provider.",
  "settings.aladdin.image.model.placeholder": "Provider model ID",
  "settings.aladdin.image.provider.drawThings": "Draw Things (local)",
  "settings.aladdin.image.keys.title": "Cloud API keys",
  "settings.aladdin.image.keys.description": "Keys stay in OpenCode's existing server credential store.",
  "settings.aladdin.image.keys.action": "Manage providers",
  "settings.aladdin.image.drawThingsModels.title": "Draw Things models",
  "settings.aladdin.image.drawThingsModels.description":
    "Detected models appear here; comma-separated manual names are also supported.",
  "settings.aladdin.image.drawThingsModels.placeholder": "Detected or manual model names",
  "settings.aladdin.image.drawThingsModel.title": "Active Draw Things model",
  "settings.aladdin.image.drawThingsModel.description": "Choose a discovered or manually entered model for image generation.",
  "settings.aladdin.image.discovery.title": "Discover local models",
  "settings.aladdin.image.discovery.description":
    "Scans Draw Things' documented local model folder and keeps manual entries.",
  "settings.aladdin.image.discovery.action": "Refresh models",
  "settings.aladdin.mobile.title": "Same-Wi-Fi mobile access",
  "settings.aladdin.mobile.description": "Serves this Mac to your phone over HTTPS, so voice and images work from the couch.",
  "settings.aladdin.mobile.passwordRequired": "Set a server password first, so only you can reach this Mac.",
  "settings.aladdin.mobile.enabled": "Mobile access is on",
  "settings.aladdin.mobile.disabled": "Mobile access is off",
  "settings.aladdin.mobile.error.title": "Could not change mobile access",
  "settings.aladdin.mobile.url.title": "Open on your phone",
  "settings.aladdin.mobile.url.description":
    "Join the same Wi-Fi, then open this address in Safari. Copy sends the full link, so there is nothing to type.",
  "settings.aladdin.mobile.copy": "Copy",
  "settings.aladdin.mobile.copied": "Copied",
  "settings.aladdin.mobile.certificate.title": "Certificate",
  "settings.aladdin.mobile.certificate.description":
    "Your phone needs this file before it will allow the microphone.",
  "settings.aladdin.mobile.trust.title": "Trust it on iPhone or iPad",
  "settings.aladdin.mobile.trust.description":
    "After installing the file, turn it on in Settings › General › About › Certificate Trust Settings.",
  "settings.aladdin.mobile.trust.airdrop": "Send the file with AirDrop, then open it",
  "settings.aladdin.mobile.addresses.title": "This Mac",
  "settings.aladdin.mobile.addresses.description": "Addresses your phone can reach on this network.",
  "settings.aladdin.mobile.addresses.none": "No network address found",
  "prompt.voice.start": "Record voice message",
  "prompt.voice.stop": "Stop recording",
  "prompt.voice.transcribing": "Transcribing locally…",
  "prompt.voice.call.start": "Start call",
  "prompt.voice.call.stop": "End call",
  "prompt.voice.call.stopPhase": "End call · {{phase}}",
  "prompt.voice.phase.listening": "Listening",
  "prompt.voice.phase.transcribing": "Transcribing",
  "prompt.voice.phase.waiting": "Thinking",
  "prompt.voice.phase.speaking": "Speaking",
  "prompt.voice.error.title": "Voice input unavailable",
  "prompt.voice.error.description": "Check the local speech service and microphone permission.",
  "prompt.voice.error.size": "Record a voice message shorter than 30 MB",
  "prompt.voice.error.transcription": "Transcription failed ({{status}})",
  "prompt.voice.error.noSpeech": "No speech was detected",
  "prompt.voice.error.output": "Speech output failed ({{status}})",
  "prompt.voice.error.outputInvalid": "Speech output was invalid",
  "prompt.voice.error.timeout": "The call timed out waiting for a response",
  "prompt.image.start": "Generate image",
  "prompt.image.dialog.title": "Generate an image",
  "prompt.image.dialog.prompt": "Prompt",
  "prompt.image.dialog.placeholder": "Describe the image you want Aladdin to create…",
  "prompt.image.dialog.provider": "Provider",
  "prompt.image.dialog.model": "Model",
  "prompt.image.dialog.size": "Size",
  "prompt.image.dialog.generate": "Generate and attach",
  "prompt.image.dialog.generating": "Generating…",
  "prompt.image.error.title": "Image generation failed",
  "prompt.image.error.description": "Check the selected model, provider credentials, or Draw Things server.",
  "prompt.image.error.failed": "Image generation failed ({{status}})",
  "prompt.image.error.invalid": "The image provider returned an invalid response",
  "prompt.image.error.attach": "The generated image could not be attached to the message",
  ...
  "settings.general.row.look.title": "Look",
  "settings.general.row.look.description": "Choose the window style used for panels, dialogs, and controls",
  "settings.general.row.look.option.classic": "Classic",
  "settings.general.row.look.option.liquidGlass": "Liquid Glass",
