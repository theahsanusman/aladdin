...
export const dict = {
  ...
  "settings.aladdin.voice.callMode.title": "Call mode",
  "settings.aladdin.voice.callMode.description": "Listen, submit, speak the final answer, then listen again.",
  ...
  "settings.aladdin.mobile.description": "Requires password-protected trusted HTTPS before it can be enabled.",
